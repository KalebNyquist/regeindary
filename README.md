...
The reference MongoDB generated by Regeindary has standalone value, but has primarily been developed for use with [Nipwiss](https://github.com/KalebNyquist/regeindary).
